...
export default function Activities({isMobile, parsedActivities, totalActivities, setParsed, selectedActivities}) {
  ...
  return (
    <Box sx={{backgroundColor:"#ffffff",           
        ...
        <Box component="section" sx={{padding: "20px",  display: 'flex',  justifyContent: 'space-between' }}>
          ...
          >
          <MenuItem sx={{ borderRadius: '16px'}}><AlertDialogSlide setParentDates={setParentDates}/></MenuItem>
